...
% --- Custom Color ---
\definecolor{maincolor}{rgb}{0, 0.2, 0.4}
...
% Redefined section formats with color
\titleformat{\section}{\vspace{-5pt}\scshape\raggedright\large\color{maincolor}}{}{0em}{}[\color{maincolor}\titlerule \vspace{-5pt}]
\titleformat{\subsection}{\vspace{-3pt}\scshape\raggedright\normalsize\color{black}}{}{0em}{}[\color{black}\vspace{-6pt}]
...
% -------------------- HEADING --------------------
\begin{center}
    {\Huge \textbf{\scshape\textcolor{maincolor}{Vidhata Jayaraman}}}\\[5pt]
    \small
    {\color{maincolor}\faIcon{envelope}} \href{mailto:vidhata2@illinois.edu}{vidhata2@illinois.edu} {\raisebox{1.5pt}{\tiny\textbullet}}\ 
    {\color{maincolor}\faIcon{phone-square-alt}} 847-420-5370 {\raisebox{1.5pt}{\tiny\textbullet}}\ 
    {\color{maincolor}\faIcon{linkedin}} \href{https://www.linkedin.com/in/vidhata-jayaraman/}{/in/vidhata-jayaraman} {\raisebox{1.5pt}{\tiny\textbullet}}\ 
    {\color{maincolor}\faGraduationCap} \href{https://scholar.google.com/citations?user=f16twSMAAAAJ&hl=en}{Google Scholar} {\raisebox{1.5pt}{\tiny\textbullet}}\ 
    {\color{maincolor}\faIcon{safari}} \href{https://dxdt14.github.io/}{dxdt14.github.io}
\end{center}
...
\section{Education}
\textbf{University of Illinois Urbana-Champaign (UIUC)} \hfill Anticipated Graduation: May 2026\\
\textit{B.S. in Computer Engineering $|$ B.S. in Mathematics} \hfill \textit{GPA: 3.97/4.0} \\
\small Dean's List (Top 20\% of Student Body)

% -------------------- RESEARCH EXPERIENCE --------------------
\section{Research Experience}

\textbf{Research with Professor Lav Varshney at UIUC} \hfill February 2024 -- Present\vspace{-8pt}
...
\textbf{Algorithms \& Models of Computation Classroom Assistant} \hfill August 2025 -- Present\vspace{-5pt}
\begin{itemize}[itemsep=-5pt, parsep=5pt, leftmargin=0.25in]
    \item Assisting in quiz and exam grading and holding 2-hour-long office hours weekly.
...
\end{itemize}
\textbf{Analog Signal Processing (ECE 210) Tutor (IEEE-HKN)} \hfill August 2023 -- May 2024\vspace{-5pt}
\begin{itemize}[itemsep=-5pt, parsep=5pt, leftmargin=0.25in]
...
\begin{paracol}{2}
    ...
    \raggedright\textbf{Math}: Real Analysis; Complex Analysis; Abstract Algebra; Linear Algebra; Probability Theory; Algebraic Topology; Graph Theory; Differential Equations; Probability \& Measure \\
    \vspace{10pt}
    \raggedright\textbf{Applied Math/CS}: Optimization; Machine Learning; Deep Learning for CV; Deep Generative Models; Random Processes; Information Theory; Quantum Information Theory; Algorithms; Data Structures; Signal Processing \\
    
    % -------------------- AWARDS --------------------
    
    \section{Grants \& Awards}
    \begin{itemize}[itemsep=-3pt, parsep=5pt, leftmargin=0.25in]
        \item Research grant from the Office of Undergraduate Research \hfill 2025
        \item UIUC James Scholar \hfill 2023 -- 2025
        \item Member, Eta Kappa Nu (IEEE-HKN) ECE Honor Society \hfill 2023
        \item Member, Tau Beta Pi Engineering Honor Society \hfill 2023
        \item AIME Qualifier (American Invitational Mathematics Examination) \hfill 2022
        \item Illinois State Seal of Biliteracy in Spanish \hfill 2020
    \end{itemize}
